...
if __name__ == "__main__":
    ...
    collected_results.append(train_and_evaluate_model(DecisionTreeClassifier(), hyper_param_distribution, n_iter=50))
    ...
    collected_results.append(train_and_evaluate_model(RandomForestClassifier(), hyper_param_distribution, n_iter=50))
    ...
    collected_results.append(train_and_evaluate_model(MLPClassifier(), hyper_param_distribution, n_iter=50))
    ...
    for result in collected_results:
        ...
        results_table.add_row(
            [classifier_name, f"{result['mean_cv']:.3f}", f"{result['stdv_cv']:.3f}", f"{result['test_score']:.3f}"]
        )
    print(results_table)
